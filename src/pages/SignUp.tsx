...
const SignUp: React.FC = () => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    console.log('Sign up attempted with:', { name, age, username, password, confirmPassword });
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 to-black text-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold">Join Floowy</h2>
          <p className="mt-2 text-sm text-gray-400">Start your musical journey today</p>
        </div>
